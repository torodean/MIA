...
\begin{itemize}\itemsep0em
	...
	Logs a message to the default log file with optional tags, formatted the same way as the \texttt{Logger} class tags overload.
	...
	Logs a message to a specified file with optional tags, formatted the same way as the \texttt{Logger} class tags overload.
