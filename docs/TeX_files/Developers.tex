...
\label{section:dependancy_structure}
...
\label{section:base_application}
...
\label{section:global_constants_and_paths}
...
\label{section:configuration_system}
...
\label{section:logging_Framework}
