...
\begin{enumerate}
	...
	\item \inlinecode{LISTEN=10} This will open a background thread which listens for the key corresponding to a key code of 10 (the 1 key). When detected, the sequence will toggle on and off. When toggled, the sequence will stop or restart. 
