...
\begin{table}[h]
	...
	\begin{tabularx}{\textwidth}{|l|l|X|}
		...
		\hline
		\texttt{PRESSRANDNUM} & Integer pair & MIN;MAX integer pair separated by a semi-colon (e.g., 2;5) and ordered from small to large (left to right). \\
		\hline
		...
		\hline
		\texttt{CLICKHOLD} & Enum (ClickType);Integer (ms) & One of: \texttt{LEFTCLICK}, \texttt{RIGHTCLICK}, \texttt{MIDDLECLICK}, followed by a semi-colon delimiter, then a delay to hold each character in milliseconds. \\
		\hline
